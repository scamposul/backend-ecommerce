            ...
            <td style="padding:4%;">
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border-spacing:0;text-align:left;">
                    ...
                    <table>
                      <tr>
                        <td>
                          <h5 style="font-weight: 700;font-size: 20px;line-height: 150%;">
                            Bienvenido al Charco de la Pava
                          </h5>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>
                          <p
                            style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                            Gracias por registrarte en El Charco de la Pava.
                            El mejor portal de agroinsumos y herramientas. Le invitamos a visitar nuestra página (aún sin front-end) y enterarse de nuestros magníficos descuentos.
                            Visítenos en nuestra tienda física en Cotorra, Córdoba (Calle 892 # 567 -11223).
                            A partir de ahora, usaremos su correo electrónico para enviarle spam y promociones molestas.
                      ...
                      <tr>
                        <td>
                          <p
                            style="font-weight:400;font-size: 16px;line-height: 150%;letter-spacing: 0.2px;color: #333333;">
                          <p>Atentamente, <br />Lamaetuyacrazyshit</p>
                          </p>
                        </td>
                      </tr>
                      <tr>
                ...
                <tr>
                  <td>
                    <p>
                      Comentarios y/o sugerencias, favor no escribirnos a nosotros (andamos ocupaditos).
                    </p>
                  </td>
                </tr>
              </table>
